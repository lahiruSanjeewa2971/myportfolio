      ...
      <div className="max-w-[1300px] mx-auto flex justify-between text-gray-200 text-xl items-center px-12 h-20">
        ...
        >
          <ul className="font-semibold text-4xl space-y-8 mt-24 text-center">
            <li>
              <Link to="skills" smooth={true} offset={50} duration={500} onClick={closeNav}>
                About
              </Link>
            </li>
            <li>
              <Link to="portfolio" smooth={true} offset={50} duration={500} onClick={closeNav}>
                Portfolio
              </Link>
            </li>
            <li>
              <Link to="contact" smooth={true} offset={50} duration={500} onClick={closeNav}>
                Contact
              </Link>
            </li>
          </ul>
